MODULE PARAMS
  !Below are the parameters for the simplest IBM without any trait.
implicit NONE
...
!Mutation parameters (irrelvant in this model)
integer, parameter :: NTrait = 0
real     :: nu(NTrait)     !Probability per generation per cell
real     :: sigma(NTrait)  !Standard deviation of mutation of the three traits
